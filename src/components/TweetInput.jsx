    ...
    <div className='tweetinput' id='tweetInput'>
        <div className='tweetinput--container'>
            ...
            <div className='tweetinput--interactive'>
                ...
                <button disabled className='tweetinput--interactive__button'>Tweet</button>
                </div>
            </div>
        </div>
    </div>
