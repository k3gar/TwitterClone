...
const PostHome = () => {
  return (
    <div className='published-post'>
        <img className='published-post_user_pic' src="https://pbs.twimg.com/profile_images/1060271522319925257/fJKwJ0r2_400x400.jpg" alt="" />
        <div className='published-content'>
            <div className='published-post_text'>
                <div className='published-post_text-user'>
                    <h3>The Washington Post</h3>
                    <p>@bibiblotimia</p> <p>·</p><p>43m</p>
                </div>
                <div className='published-post_text-dots'>
            ...
            <p>Survivor of four Nazi concentration camps is killed in Ukraine, foundation says</p>
